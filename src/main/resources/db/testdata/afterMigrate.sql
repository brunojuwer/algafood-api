...
insert into pedido (codigo, sub_total, taxa_frete, valor_total, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, status, data_criacao) values ('353cd853-9c41-11ed-bfcd-0242ac110002', 50, 20, 70, 1, 1, 3, 1, '999999900', 'rua pastel', '432W', 'Interior', 'CRIADO', utc_timestamp);

insert into pedido (codigo, sub_total, taxa_frete, valor_total, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, status, data_criacao) values ('3a68add0-9c41-11ed-bfcd-0242ac110002', 70, 30, 100, 2, 4, 2, 2, '999999900', 'Rua Yoshida', 'A210', 'Centro', 'CRIADO', utc_timestamp);
